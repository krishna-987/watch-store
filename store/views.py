...
# from store.models import Payment   # ✅ correct import
# from .models import Product, Category, Favorite   # ❌ removed duplicate Payment
...
#         category__name__iexact="Eyewear"
